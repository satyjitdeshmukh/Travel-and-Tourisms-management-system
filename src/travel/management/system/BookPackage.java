...
public class BookPackage extends JFrame {
	...
	public BookPackage(String username) {
		...
		JLabel lbl4 = new JLabel("From Where ");
		lbl4.setBounds(35, 190, 200, 14);
		...
		JLabel lbl2 = new JLabel("To Where");
		lbl2.setBounds(35, 230, 200, 14);
		contentPane.add(lbl2);
		t1 = new JTextField();
		t1.setText(" ");
		t1.setBounds(271, 230, 150, 20);
		contentPane.add(t1);
		t1.setColumns(10);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookPackage (c1,t1,l2,l3,l4,l5) values('"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
