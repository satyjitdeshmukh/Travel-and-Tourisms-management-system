...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"package1.jpg","FRIST CLASS ","", "", "Mean include", "Welcome drinks on Arrival", "Daily Buffet", "High class ac", "English Speaking Guide", "BOOK NOW", " Special", "Rs 12000 only"};
      String[] package2 = new String[]{"package2.jpg","SECOND CLASS","", "", "Mediam level AC", "Welcome drinks on Arrival", "", "Full Day meal", " Dinner", "BOOK NOW", " Special", "Rs 2500 only"};
      String[] package3 = new String[]{"package3.jpg","THIRD CLASS/SLIPPER","", "", "AC is not present", "Welcome drinks on Arrival", "Daily Buffet", "", " Dinner", "BOOK NOW", " Special", "Rs 320 only"};
